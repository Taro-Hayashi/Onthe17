...
> [!IMPORTANT] 
> 全数テスト後に発送しておりますがはんだ付けの前に必ず一度確認してください。
...
### スクロールのしかた
左上のキーは打鍵するとTABキーですが、押しながらトラックボールを操作するとカーソル移動ではなくスクロールになります。
![](img/scroll.jpg)   
同様に英数キーは長押しでスクロール、かなキーは長押しでカーソルの速度が遅くなります。
これらはRemapで自由に変更することができます。

### トラックボールの設定の変更
一番上の行の左から2番目のキーを押しながら操作するとトラックボールの設定を変更できます。
![](img/ball.jpg)   
